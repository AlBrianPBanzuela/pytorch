...
class TestSymIntResolution(JitTestCase):
    ...
    def test_auto_resolve_symint_in_call_function(self):
        ...
        node = new_graph.call_function(torch.ops.aten.empty.memory_format, ([s0],))
        # The arg should be a Node, not a SymInt
        self.assertIsInstance(node.args[0][0], torch.fx.Node)
    ...
    def test_auto_resolve_compound_symint(self):
        ...
        node = new_graph.call_function(torch.ops.aten.empty.memory_format, ([numel],))
    ...
    def test_concrete_symint_becomes_int(self):
        ...
        node = new_graph.call_function(torch.ops.aten.empty.memory_format, ([42],))
    ...
    def test_no_symint_args_unchanged(self):
        ...
        node = new_graph.call_function(torch.ops.aten.reshape.default, (new_ph, [-1]))
    ...
    def test_symint_to_node_explicit_api(self):
        ...
        self.assertIsInstance(result, torch.fx.Node)
